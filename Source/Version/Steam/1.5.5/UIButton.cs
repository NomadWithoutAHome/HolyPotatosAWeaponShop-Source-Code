...
public class UIButton : UIButtonColor
{
	...
	protected override void OnInit()
	{
		if (adjustments)
		{
			OrigPos = GetComponentInChildren<UILabel>().transform.localPosition;
		}
		base.OnInit();
	...
	{
		if (adjustments && GetComponentInChildren<UILabel>() != null && OrigPos != GetComponentInChildren<UILabel>().transform.localPosition)
		{
			GetComponentInChildren<UILabel>().transform.localPosition = OrigPos;
		}
	...
	public override void SetState(State state, bool immediate)
	{
		...
		if (mSprite != null)
		{
			...
			case State.Hover:
				...
				break;
			case State.Pressed:
				if (adjustments && GetComponentInChildren<UILabel>() != null && GetComponentInChildren<UILabel>().transform.localPosition == OrigPos)
				{
					Vector3 localPosition2 = GetComponentInChildren<UILabel>().transform.localPosition;
					localPosition2.y += yValue;
					GetComponentInChildren<UILabel>().transform.localPosition = localPosition2;
				}
			...
			case State.Disabled:
				if (adjustments && GetComponentInChildren<UILabel>() != null && GetComponentInChildren<UILabel>().transform.localPosition == OrigPos)
				{
					Vector3 localPosition = GetComponentInChildren<UILabel>().transform.localPosition;
					localPosition.y += yValue;
					GetComponentInChildren<UILabel>().transform.localPosition = localPosition;
				}
